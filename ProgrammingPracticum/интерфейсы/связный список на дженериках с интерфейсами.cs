...
namespace дз_по_тетсированию_Двусвязных_списков
{
    ...
    class MyList<T> : ICollection<T>, IEnumerable
    {
        ...
        public MyList(T s) { head.Value = Convert.ToString(s); tail = head; Count = 1; }
